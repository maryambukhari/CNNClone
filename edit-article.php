...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE articles SET title = ?, content = ?, category_id = ?, thumbnail = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?");
    $stmt->bind_param("ssisi", $title, $content, $category_id, $thumbnail, $id);
    $stmt->execute();
    $stmt->close();
    header("Location: admin_dashboard.php");
    exit();
    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="content" rows="5" required><?php echo htmlspecialchars($article['content']); ?></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="thumbnail" id="thumbnail" value="<?php echo htmlspecialchars($article['thumbnail']); ?>">
            </div>
